...
const STACK_GROUPS = [
  {
    ...
    items: [
      ...
      { name: "shadcn/ui", src: "/tecklogo/shadcnui.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Express", src: "/tecklogo/express.png" },
      { name: "MySQL", src: "/tecklogo/mysqllogo.png" },
      { name: "PostgreSQL", src: "/tecklogo/postgresql.png" },
      { name: "MongoDB", src: "/tecklogo/mongodb.png" },
      { name: "Mongoose", src: "/tecklogo/mongoose.png" },
  ...
  },
  {
    ...
    items: [
      { name: "GraphQL", src: "/tecklogo/graphql.png" },
      { name: "Linux", src: "/tecklogo/linux.png" },
      { name: "Bash", src: "/tecklogo/bash.png" },
      { name: "Git", src: "/tecklogo/git.png" },
