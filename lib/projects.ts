...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    description:
      "Telegram Mini App learning portal for Darulkubra, fully bilingual in Amharic and English. Students browse rated course catalogs, work through sectioned curricula with sequentially unlocking video lessons, take in‑lesson quizzes, and ask questions through a built‑in Q&A — while a personal dashboard tracks attendance, exam results, lesson activity, and wallet balance in ETB.",
    image: "/terbialearning/1.png",
    images: [
      "/terbialearning/1.png",
      "/terbialearning/4.png",
      "/terbialearning/3.png",
      "/terbialearning/2.png",
    ],
    badge: "Fullstack",
    category: "Web Development",
